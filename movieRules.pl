...
pelicula(9,shrek_2,2004,estados_unidos,comedia).
pelicula(10,soy_leyenda,2007,estados_unidos,accion).
...
mayor(Pelicula,Actor,Actriz,Anio,Genero,Director,Pais):- pelicula(_, Pelicula, Anio, Pais, Genero),Anio>2000,actor(Pelicula,Actor,_),actriz(Pelicula,Actriz,_),director(Pelicula,Director). 
%Aca va su codigo
...
encuentra(Actor,Anio,Pais,Director):- director(Pelicula, Director),pelicula(_, Pelicula, Anio, Pais, _),actor(_, Actor, _),Actor=jordi_mollà.
%Aca va su codigo
...
peliculas(Genero,Anio,Pelicula,Director,Actores,Actrices):- director(Pelicula,Director),pelicula(_,Pelicula,Anio,_,Genero),Genero=drama,actor(Pelicula,Actores,_),actriz(Pelicula,Actrices, _).
%Aca va su codigo
